...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2013 at 04:04 PM
...
(2, 0, 299, 2, 'Child playing shooters', 1365514786),
(3, 0, 699, 3, 'Training teen', 1365514847),
(4, 0, 1499, 4, 'Kind of terrifyer', 1365514882),
(5, 0, 3099, 5, 'Mafia school student', 1365514924),
(6, 0, 6299, 6, 'Graduating mafia school', 1365514956),
(7, 0, 12699, 7, 'Beginner assassin', 1365514991),
(8, 0, 25499, 8, 'Intermediate killer', 1365515027),
(9, 0, 51099, 9, 'Serial killer', 1365515053),
(10, 0, 102299, 10, 'Potential mindblower', 1365515079),
(11, 0, 204699, 11, 'Perfect shooter', 1365515109),
(12, 0, 409499, 12, 'Mafia team leader', 1365515174),
(13, 0, 819099, 13, 'King of Family', 1365515211),
(14, 0, 1638299, 14, 'Regional Mafia leader', 1365515273),
(15, 0, 3276699, 15, 'King of the Kings - only few have reached this level!', 1365515332);

-- --------------------------------------------------------

--
-- Table structure for table `char_leveling_bonus_points`
--

DROP TABLE IF EXISTS `char_leveling_bonus_points`;
CREATE TABLE IF NOT EXISTS `char_leveling_bonus_points` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `char_id` int(11) NOT NULL,
  `melee_damage_point` int(11) NOT NULL,
  `distance_damage_point` int(11) NOT NULL,
  `melee_resistance_point` int(11) NOT NULL,
  `distance_resistance_point` int(11) NOT NULL,
  `building_speed_point` int(11) NOT NULL,
  `timestamp` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `char_id` (`char_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
--
-- Dumping data for table `char_leveling_bonus_points`
--

INSERT INTO `char_leveling_bonus_points` (`id`, `char_id`, `melee_damage_point`, `distance_damage_point`, `melee_resistance_point`, `distance_resistance_point`, `building_speed_point`, `timestamp`) VALUES
(1, 1, 2, 1, 4, 3, 3, 1365598752),
(2, 2, 4, 2, 1, 1, 1, 1365598752);
...
INSERT INTO `user_chars` (`id`, `user_id`, `char_id`, `current_hp`, `hp_update_timestamp`, `char_exp`, `char_level`, `timestamp`) VALUES
(1, 1, 1, 100, 1364454727, 0, 1, 1364454727),
(2, 4, 2, 100, 1365577065, 14, 15, 1364454753);
...
(2, 4, 4.75, 2000, 1365602664, 5, 1364454884);
